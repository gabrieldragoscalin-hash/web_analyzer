...
def build_detailed_pdf(url: str, analysis: dict, detailed_report: dict) -> bytes:
    ...
    for item in detailed_report.get("findings", []):
        ...
        if code_example:
            story.append(Paragraph("Example fix:", styles["Heading4"]))
    ...
    story.append(Spacer(1, 0.2 * inch))
    story.append(Paragraph("This premium report is designed to help business owners understand the problem and take practical next steps.", styles["BodyText"]))
